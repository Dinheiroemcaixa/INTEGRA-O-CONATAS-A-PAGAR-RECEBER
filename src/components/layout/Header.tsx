    ...
    <header className="h-16 bg-dark-900 border-b border-dark-700 flex items-center justify-between px-6 flex-shrink-0">
      ...
      <div ref={refEmpresa} className="relative">
        <button
          ...
          className="flex items-center gap-2.5 bg-dark-800 hover:bg-dark-700 border border-dark-600 rounded-lg px-3 py-2 transition-all group"
        >
        ...
        {openEmpresa && (
          <div className="absolute top-full mt-2 left-0 w-72 bg-dark-800 border border-dark-600 rounded-xl shadow-2xl z-50 overflow-hidden animate-fade-in">
            ...
            {empresas.length === 0 ? (
              ...
              empresas.map((emp) => (
                ...
                >
                  ...
                  {empresaAtiva?.id === emp.id && <Check size={14} className="text-green-400 flex-shrink-0" />}
                </button>
              ))
            )}
          </div>
      ...
      <div ref={refUser} className="relative">
        ...
        {openUser && (
          <div className="absolute top-full mt-2 right-0 w-56 bg-dark-800 border border-dark-600 rounded-xl shadow-2xl z-50 overflow-hidden animate-fade-in">
